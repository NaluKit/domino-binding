...
/**
 * Basic implementation of {@link org.gwtproject.event.shared.EventBus}.
 */
public class SimpleEventBus
  ...
  private <H> void doRemove(Type<H> type,
                            Object source,
                            H handler) {
    if (firingDepth > 0) {
      enqueueRemove(type,
  ...
  private <H> HandlerRegistration doAdd(final Type<H> type,
                                        final Object source,
                                        final H handler) {
    if (type == null) {
  ...
  private <H> void doAddNow(Type<H> type,
                            Object source,
                            H handler) {
  ...
  private <H> void doRemoveNow(Type<H> type,
                               Object source,
                               H handler) {
  ...
  private <H> void enqueueAdd(final Type<H> type,
                              final Object source,
                              final H handler) {
    defer(() -> doAddNow(type,
                         source,
  ...
  private <H> void enqueueRemove(final Type<H> type,
                                 final Object source,
                                 final H handler) {
  ...
  private <H> List<H> ensureHandlerList(Type<H> type,
                                        Object source) {
  ...
  private <H> List<H> getDispatchList(Type<H> type,
                                      Object source) {
  ...
  private <H> List<H> getHandlerList(Type<H> type,
                                     Object source) {
